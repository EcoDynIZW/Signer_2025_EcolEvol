...
res <- mclapply(1:2, function(i) try({
  ...
  base_name <- if (hpc) "/home/proj/results/" else here("output", "simulated", "single_runs")
  file_name <- paste0(base_name, "/results_", str_pad(cc["run_id"], 6, pad = "0"), ".rds")
  lscp_path <- if (hpc) "/home/proj/data/landscapes/" else here("data", "simulated", "landscapes")
